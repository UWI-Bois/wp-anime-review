        ...
        <?php
            ...
            <div class="mg-blog-post-box">
              <div class="mg-header">
                ...
                <h1 class="title single"> <a href="<?php echo esc_url(get_the_permalink()); ?>#content" title="<?php the_title_attribute( array('before' => esc_html_e('Permalink to: ','newsup'),'after'  => '') ); ?>">
                  <?php the_title(); ?></a>
                </h1>
              ...
              echo '<a class="mg-blog-thumb" href="' . esc_url(get_the_permalink()) . '#content';
                                  ...
                                  <div class="col-md-4">
                                    <div class="mg-blog-post-3">
                                        ...
                                        <div class="mg-blog-img">
                                            <?php echo '<a class="mg-blog-thumb" href="' . esc_url(get_the_permalink()) . '#content';
                                              the_post_thumbnail( '', array( 'class'=>'img-responsive' ) );
                                              echo '</a>';
                                             ?>
                                        </div>
